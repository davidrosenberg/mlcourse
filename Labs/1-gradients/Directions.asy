...
//draw(surface(g,(-.1,-.5),(1,1),50,Notaknot,Notaknot),surfacepen=lightblue+opacity(.9),black);
draw(surface(g,(-1,-1),(1,1),50,Notaknot,Notaknot),surfacepen=lightblue+opacity(.9),black);
real r = 2;
triple c = (0,.1,.3);
dot(g((0,.1)),red+5);
