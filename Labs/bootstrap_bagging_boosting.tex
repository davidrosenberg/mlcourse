...
\end{frame}
%
\begin{frame}{Question 4: Bagging and Random Forest}
\begin{itemize}
...
\item Once a weak classifier is picked in a particular round, it will never be chosen in any subsequent round.
\end{itemize}
