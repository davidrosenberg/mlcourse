...
\begin{itemize}
	...
	\pause{}
	\item $\phi(X) = \left[\mathbbm{1}(X \leq \frac{1}{400}), \cdots,\mathbbm{1}(X \leq \frac{399}{400}) \right]$
\end{itemize}
\end{frame}
...
\end{itemize}
\begin{center}
\includegraphics[width=0.75\columnwidth]{../Figures/boston_setup.png} 
\par\end{center}
\end{frame}
...
\end{itemize}
\begin{center}
\includegraphics[width=0.7\columnwidth]{../Figures/abalone_setup.png} 
\par\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.5\columnwidth]{../Figures/moons_setup.png} 
\par\end{center}
\begin{itemize}
	\item What feature maps might be helpful for this problem?
	\pause{}
	\item We'll try binning data instances using k-means (and for fun random tree embeddings) -- let's look at the transformers (\textit{in notebook}).
\end{itemize}
\let\thefootnote\relax\footnotetext{\tiny{From Alice Zheng, Amanda Casari, \textit{Feature Engineering for Machine Learning}}}
