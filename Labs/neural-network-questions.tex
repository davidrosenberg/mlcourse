...
\begin{itemize}
\item \begin{align*}
\frac{\partial \mathcal{L}}{\partial U} &= \sum_{t=1}^T \left(\Pi_{k=t-1}^{T-1} (\bU^T D_k) \right ) \bh_{t-1}^T\\
\frac{\partial \mathcal{L}}{\partial W} &= \sum_{t=1}^T \left(\Pi_{k=t-1}^{T-1} (\bU^T D_k) \right ) \bx_{t-1}^T\
\end{align*}
